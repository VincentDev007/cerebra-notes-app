        ...
        <div>
            ...
            >
                <div>
                    ...
                    <p className="text-sm ml-11 flex items-center gap-1" style={{ color: 'var(--text-secondary)' }}>
                        <Folder size={12} /> {folderName} &middot; Created {formatDate(note.created_at)} &middot; Modified {formatDate(note.modified_at)}
                    </p>
                </div>
            ...
            >
                {editing ? (
                    ...
                    <div className="flex flex-col items-center justify-center py-16 text-center">
                        <FileText size={48} className="mb-4 opacity-50" style={{ color: 'var(--text-secondary)' }} />
